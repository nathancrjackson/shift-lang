...
For detailed examples on how to integrate Shift into your own Go or JavaScript application, supply custom import resolvers, enforce instruction limits, or build/test the runtimes, please refer to the Deep Dive guides.
